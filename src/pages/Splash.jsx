...
export default function SplashScreen() {
  ...
  useEffect(() => {
    ...
    gsap.set("#startBtn", { transformOrigin: "50% 50%" });

    const btn = document.querySelector("#startBtnInner");

    btn?.addEventListener("mousedown", () => {
      gsap.to("#startBtnInner", {
        scale: 0.96,
        duration: 0.12,
      });
    });
    ...
    gsap.to("#butterflyPattern image", {
      x: -200,
      duration: 20,
      repeat: -1,
      ease: "none",
      ...
      >
        <defs>
          ...
          <linearGradient
            ...
            y2="100%"
          >
            <stop offset="0%" stopColor="#bd1379" />
            <stop offset="50%" stopColor="#e3ccb5" />
            <stop offset="100%" stopColor="#ceb6b6" />
          </linearGradient>
          ...
          <linearGradient
            ...
            y2="0%"
          >
            <stop offset="0%" stopColor="#11ab7d" />
            <stop offset="50%" stopColor="#e0060e" />
            <stop offset="100%" stopColor="#e7e30a" />
          </linearGradient>
        ...
        <g id="scene3" style={{ visibility: "hidden" }}>
          ...
          <g id="startBtn">
            <g id="startBtnInner" style={{ cursor: "pointer" }} onClick={handleStart}>
              <rect
                id="startBtnRect"
                x="330"
                y="370"
